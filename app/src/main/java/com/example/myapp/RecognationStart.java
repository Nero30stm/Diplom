...
public class RecognationStart extends AppCompatActivity  implements OnClickListener{
    ...
    double[][] cancelledResult = {{100}}; //массив даубл используется для publishProgress(cancelledResult);
    int mPeakPos;
    double mHighestFreq;
    ...
    static RecognationStart mainActivity;
    LinearLayout main;
    int width;
    int height;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setContentView(R.layout.activity_recognation_start);
...
private class RecordAudio extends AsyncTask<Void, double[], Boolean> {
    ...
    static RecognationStart getMainActivity(){
